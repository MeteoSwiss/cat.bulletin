...
bulletin_to_pdf(bulletin, language = "fr", filename = file.path(bulletin$bulletin_path, "fr.pdf"))
bulletin_to_pdf(bulletin, language = "de", filename = file.path(bulletin$bulletin_path, "de.pdf"))
